...
# ################################################此处举例子使用手柄按键的示例####################################################
# '''
#             if ps2.ButtonPressed('PAD_LEFT'):  				#左边向上按钮收到 按下
#                 uart.uart_send_str('#021P2000T2000!')		#将021号设备移动到PWM2000的位置
#             if ps2.ButtonPressed('PAD_RIGHT'):  				#左边向上按钮收到 按下
#                 uart.uart_send_str('#022P0500T2000!')		#将022号设备移动到PWM0500的位置
#                 
# '''
# #################################################################################################################################
...
# ################################################此处举例子使用手柄遥感的示例####################################################
#                     #本程序已经将遥控器设置为红灯模式，遥感输出的是模拟数值范围分别是0-255，中间位置是128
# '''
#         #将四个遥感的实际数值赋给四个变量
